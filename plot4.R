...
# First plot
plot(power_dataframe$timestamp, power_dataframe$Global_active_power, type="l", xlab="", ylab="Global Active Power")

# Second plot
plot(power_dataframe$timestamp, power_dataframe$Voltage, type="l", xlab="datetime", ylab="Voltage")
...
# Fourth plot
plot(power_dataframe$timestamp, power_dataframe$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
